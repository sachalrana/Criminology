...
public class DatabaseHelper : IDisposable
{
    ...
    public DatabaseHelper(string connectionstring, Providers provider)
    {
        ...
        switch (provider)
        {
            ...
            case Providers.ConfigDefined:
                string providername = ConfigurationManager.ConnectionStrings["AIT581"].ProviderName;
                switch (providername)
                {
    ...
    public DatabaseHelper(Providers provider)
        : this(ConfigurationManager.ConnectionStrings["AIT581"].ConnectionString, provider)
    {
    }
    ...
    public DatabaseHelper()
        : this(ConfigurationManager.ConnectionStrings["AIT581"].ConnectionString, Providers.ConfigDefined)
    {
    }
